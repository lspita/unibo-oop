...
public final class AnotherConcurrentGUI extends JFrame {
    ...
    private final TimedStopCounterAgent timedStopCounterAgent = new TimedStopCounterAgent(counterAgent);
    ...
    public AnotherConcurrentGUI() {
        ...
        Thread.ofPlatform().daemon(true).start(timedStopCounterAgent);
    ...
    private class TimedStopCounterAgent implements Runnable {

        private static final long TIMEOUT_MS = 10000;

        private CounterAgent counterAgent;

        public TimedStopCounterAgent(final CounterAgent counterAgent) {
