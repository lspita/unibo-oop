...
public class Test {
     ...
     * su-destra, giù-destra, finché  non collide con un bordo della griglia: ad esempio in fig2 si è clickato sulla cella di coordinate
     * (3,3) (considerando l'origine in alto-sinistra)
     ...
     * -- in fig3 e fig4 altri due esempi di triangoli, formati clickando sul loro vertice di sinistra;
