...
public final class DrawNumberControllerImpl implements DrawNumberController {
    ...
    /**
     * Check that the views collection is in a correct state
     * @throws IllegalStateException if the are no views attached
     */
    public void checkViewsState() throws IllegalStateException {
