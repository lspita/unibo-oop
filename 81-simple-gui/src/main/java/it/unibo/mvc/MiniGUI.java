...
public class MiniGUI {
    ...
    private static final String RESULT_FIELD_INITIAL_CONTENT = "Result";
    ...
    public MiniGUI() {
        ...
        mainPanel.add(write);
        final JTextField resultField = new JTextField(RESULT_FIELD_INITIAL_CONTENT);
        ...
        write.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent e) {
                ...
                resultField.setText(RESULT_FIELD_INITIAL_CONTENT + ": " + Integer.toString(randomNumber));
            }
        });
    }
